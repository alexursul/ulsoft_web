    ...
    <UModal v-model="store.shown" class="ul-modal">
      <div class="ul-modal-content">
        <div class="d-flex flex-row align-items-start justify-content-between">
          ...
          <a href="javascript:void(0)" @click="store.show(false)" class="close me-2" title="Закрыть окно">
            <img src="/img/svg/close.svg" width="18" alt="Закрыть" />
          </a>
        </div>
        <SubmitForm />
      </div>
    ...
    <UModal v-model="store.successShown" class="ul-modal">
      <div class="ul-modal-content">
        <div class="d-flex flex-row align-items-start justify-content-between">
          ...
          <a href="javascript:void(0)" @click="store.successShown = false" class="close me-2" title="Закрыть окно">
            <img src="/img/svg/close.svg" width="18" alt="Закрыть"/>
          </a>
        </div>
    ...
    <UModal v-model="store.failShown" class="ul-modal">
      <div class="ul-modal-content">
        <div class="d-flex flex-row align-items-start justify-content-between">
          ...
          <a href="javascript:void(0)" @click="store.failShown = false" class="close me-2" title="Закрыть окно">
            <img src="/img/svg/close.svg" width="18" alt="Закрыть"/>
          </a>
        </div>
